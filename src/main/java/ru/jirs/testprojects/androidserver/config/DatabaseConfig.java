 ...
 */
@Configuration
@EnableJpaRepositories("ru.jirs.testprojects.androidserver.repository")
...
public class DatabaseConfig {
    ...
    public Properties getHibernateProperties() {
        try {
            ...
            throw  new IllegalArgumentException("Not found 'hibernate.properties' in the classpath" , e);
        }
    }
}
